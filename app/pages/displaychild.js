...
export default class EditStudentRecordActivity extends Component {
  ...
  constructor(props) {
       ...
       this.state = {
         ...
         TextInput_father_name: '',
         TextInput_father_contact: '',
         TextInput_mother_name: '',
         TextInput_mother_contact: '',
     ...
     componentDidMount(){
      ...
      this.setState({
        ...
        TextInput_father_name: this.props.navigation.state.params.FATHER_NAME,
        TextInput_father_contact: this.props.navigation.state.params.FATHER_CONTACT,
        TextInput_mother_name: this.props.navigation.state.params.MOTHER_NAME,
        TextInput_mother_contact: this.props.navigation.state.params.MOTHER_CONTACT,
      })
   ...
   <View style={styles.MainContainer}>
    <View style={{flexDirection:"row"}}>
         ...
         editable={false}
          ...
          <TextInput          
            editable={false}
            value={this.state.TextInput_father_name}

            onChangeText={ TextInputValue => this.setState({ TextInput_father_name : TextInputValue }) }
          ...
          <View style={{flexDirection:"row"}}>
          <Text style={styles.titleText}>Father Contact : </Text>
          <TextInput
          editable={false}
            value={this.state.TextInput_father_contact}

            onChangeText={ TextInputValue => this.setState({ TextInput_father_contact: TextInputValue }) }
          ...
          <View style={{flexDirection:"row"}}>
          <Text style={styles.titleText}>Mother Name : </Text>
          <TextInput
          editable={false}
            value={this.state.TextInput_mother_name}

            onChangeText={ TextInputValue => this.setState({ TextInput_mother_name : TextInputValue }) }
          ...
          <View style={{flexDirection:"row"}}>
          <Text style={styles.titleText}>Mother Contact : </Text>
          <TextInput
          editable={false}
            value={this.state.TextInput_mother_contact}

            onChangeText={ TextInputValue => this.setState({ TextInput_mother_contact : TextInputValue }) }
